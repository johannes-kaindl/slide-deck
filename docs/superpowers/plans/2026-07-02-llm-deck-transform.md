...
- [ ] **Step 1: Copy the seed test** — copy `../vault-rag/tests/think_splitter.test.ts` verbatim to `tests/core/think-splitter.test.ts`, then change only the import line to:
```ts
...
- [ ] **Step 3: Vendor the implementation** — copy `../vault-rag/src/think_splitter.ts` verbatim to `src/core/llm/think-splitter.ts` (no changes).
...
- [ ] **Step 1: Write the failing test** — copy `../vault-rag/tests/endpoint.test.ts` to `tests/core/endpoint.test.ts`, change the import to `from "../../src/core/llm/endpoint"`, and append:
```ts
...
- [ ] **Step 3: Vendor + extend** — copy `../vault-rag/src/endpoint.ts` verbatim to `src/core/llm/endpoint.ts`, then append the slide-deck addition:
```ts
...
- [ ] **Step 1: Copy the seed test** — copy `../vault-rag/tests/reasoning.test.ts` to `tests/core/reasoning.test.ts`, change the import to `from "../../src/core/llm/reasoning"`.
...
- [ ] **Step 3: Vendor** — copy `../vault-rag/src/reasoning.ts` verbatim to `src/core/llm/reasoning.ts` (no changes).
...
- [ ] **Step 1: Copy the fake XHR harness** — copy `../vault-rag/tests/fake_xhr.ts` verbatim to `tests/fake_xhr.ts` (no changes).
