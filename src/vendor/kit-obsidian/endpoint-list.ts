// vendored from obsidian-kit@0.26.0 (2a7b5d7) — src/obsidian/endpoint-list.ts — verbatim except the import paths (../pure/ → ../kit/, mechanical, reproduce on re-vendor) — do not edit here otherwise.
