...
.sd-slide hr{ border:none; height:2px; width:40%; margin-inline:auto;
  /* Symmetric, eased both ways: matching 28%/72% gold-tinted shoulders around the
     centre so neither end reads as a harder edge than the other. */
  background:linear-gradient(90deg,transparent 0%,
    color-mix(in srgb,var(--sd-accent) 45%,transparent) 28%,
    var(--sd-accent) 50%,
    color-mix(in srgb,var(--sd-accent) 45%,transparent) 72%,
    transparent 100%); }
